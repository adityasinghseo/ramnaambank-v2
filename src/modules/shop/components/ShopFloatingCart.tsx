...
export default function ShopFloatingCart() {
    ...
    // Pages where the cart drawer should be active
    const activeCartPages = ["/shop", "/cart", "/checkout"];
    const isCartActive = activeCartPages.some(path => location.pathname.startsWith(path));
    ...
    const CartTriggerButton = (
        <Button
            ...
            onClick={!isCartActive ? () => navigate("/shop") : undefined}
        >
                                    ...
                                    return (
                                        <div key={item.id} className="flex gap-4">
                                            ...
                                            <div className="flex flex-1 flex-col">
                                                <span className="font-medium text-sm line-clamp-2">{displayName}</span>
